 ...
 * @title Voting
 *
 * @dev The project recommendations and requirements are not all relevant and sometimes superfluous.
 * I have therefore taken the liberty to make some modifications. This allows for a clearer
